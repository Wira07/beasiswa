...
<body>
  ...
  <div class="container">
    <div class="card login-form" style="height:550px; width: 50%;">
      <div class="card-body">
        <h3 class="text-center">PENDAFTARAN AKUN SISWA <br>UNTUK BEASISWA</h3>
        <hr>
      </div>
      <div class="card-text">
        ...
        <label for=" validationCustom03" class="form-label">Password</label>
          ...
          <div>
            <a href="login_siswa.php" style="color: white; text-decoration: noneyyy;">Kembali</a>
          </div>
        </form>
      </div>
    </div>
